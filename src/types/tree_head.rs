...
mod tests {
    ...
    fn test_create_sth_with_timestamp() {
        ...
        let sth = builder.create_sth(tree_size, root_hash.clone(), Some(timestamp)).unwrap();
    ...
    fn test_create_sth_without_timestamp() {
        ...
        let sth = builder.create_sth(tree_size, root_hash.clone(), None).unwrap();
    ...
    fn test_sth_response_serialization() {
        ...
        assert_eq!(deserialized.tree_head_signature, response.tree_head_signature);
    }
